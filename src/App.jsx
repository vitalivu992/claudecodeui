...
function AppContent() {
  ...
  const { updateAvailable, latestVersion, currentVersion } = useVersionCheck('vitalivu992', 'claudecodeui');
  ...
  }, [messages, selectedProject, selectedSession, activeSessions]); // eslint-disable-line react-hooks/exhaustive-deps
  ...
  }, [sessionId, projects, navigate]); // eslint-disable-line react-hooks/exhaustive-deps
